...
{
    public partial class Rdb : Database
    {
        public Rdb()
            : base(new SqlConnection("rdb"))
        {
            Connection.Open();
            CommonConstruct();
        }

        public Rdb(string connectionStringName)
            : base(new SqlConnection(connectionStringName))
        {
            Connection.Open();
            CommonConstruct();
        }
        ...
        [ThreadStatic] static Rdb _instance;
    ...
    {
        public static Rdb repo { get { return Rdb.GetInstance(); } }
